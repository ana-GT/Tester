...
EVT_COMMAND ( wxID_ANY, wxEVT_GRIP_SLIDER_CHANGE, ConfigTab::OnSlider )
...
GRIPTab( _parent, _id, _pos, _size, _style ) {
  ...
  // Add sliders
    mSlider_PosX = new GRIPSlider( "x", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_PosX ); 
    PosInputSizer->Add( mSlider_PosX, 1, wxEXPAND | wxALL, 1 );
  
    mSlider_PosY = new GRIPSlider( "y", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_PosY ); 
    PosInputSizer->Add( mSlider_PosY, 1, wxEXPAND | wxALL, 1 );
    
  mSlider_PosZ = new GRIPSlider( "z", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_PosZ ); 
  PosInputSizer->Add( mSlider_PosZ, 1, wxEXPAND | wxALL, 1 );
      
  // Create sizer for start buttons in 1st column
    wxBoxSizer *OrientInputSizer = new wxBoxSizer(wxVERTICAL);

  // Add sliders
    mSlider_Roll = new GRIPSlider( "roll", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_OrientRoll ); 
    OrientInputSizer->Add( mSlider_Roll, 1, wxEXPAND | wxALL, 1 );
  
    mSlider_Pitch = new GRIPSlider( "pitch", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_OrientPitch ); 
    OrientInputSizer->Add( mSlider_Pitch, 1, wxEXPAND | wxALL, 1 );
    
  mSlider_Yaw = new GRIPSlider( "yaw", 0.0, 1.0, 50, 0.01, 10, 50, this, slider_OrientYaw ); 
  OrientInputSizer->Add( mSlider_Yaw, 1, wxEXPAND | wxALL, 1 );
  ...
  // ** Add to sizerFull **
  sizerFull->Add( setPoseBoxSizer, 3, wxEXPAND | wxALL, 5 );
  ...
  setAddBoxSizer->Add( new wxRadioBox( this, wxID_ANY, wxT("Robot:"),
    ...
    mOriginYText = new wxTextCtrl(this,1016,wxT("-0.1"), wxDefaultPosition,wxSize(40,20),wxTE_LEFT);//,wxTE_PROCESS_ENTER | wxTE_RIGHT);
    ...
    mOriginZText = new wxTextCtrl(this,1018,wxT("-0.1"), wxDefaultPosition,wxSize(40,20),wxTE_LEFT);//,wxTE_PROCESS_ENTER | wxTE_RIGHT);
  ...
  // ** Add to sizerFull **
  sizerFull->Add( setAddBoxSizer, 1, wxEXPAND | wxALL, 5 );
...
void ConfigTab::OnSlider( wxCommandEvent &evt ) {
    ...
    if ( selectedTreeNode == NULL ) {
        return;
    } */ /// Do I need this now? - AHQ: Dec 6th, 2011
    ...
    case slider_OrientRoll:
      gTargetPose(3) = pos;
      break;

    case slider_OrientPitch:
      gTargetPose(4) = pos;
      break;
      
    case slider_OrientYaw:
      gTargetPose(5) = pos;
      break;
