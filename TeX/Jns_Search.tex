...
\begin{figure}[]
  \centering
  \subfigure[Start conf. and target location]{
    \includegraphics[height=90pt]{figures/Experiment_Barret_Path_2_StartTarget_560x560.png} 	
  }
  \subfigure[Workspace path $(x,y,z)$]{
    \includegraphics[height=100pt]{figures/Experiment_Barret_WSPath_2_550x400.png} 
  } \\
  \subfigure[Execution]{
    \includegraphics[height=90pt]{figures/Experiment_Barret_Path_2_Layered_560x560.png} 	
  }
  %\subfigure[Joints vs time steps]{
  %  \includegraphics[height=50pt]{figures/Experiment_LWA3_Path_2_Joints_620x340.png} 
  %}  
